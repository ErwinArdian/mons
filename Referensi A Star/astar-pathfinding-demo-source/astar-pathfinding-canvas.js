...
function redraw()
{
	...
	for (var x=0; x < worldWidth; x++)
	{
		for (var y=0; y < worldHeight; y++)
		{
			...
			{
			case 1:
				spriteNum = 1 //no 1 = stone
				break;
			default:
				spriteNum = 0; // no 0 = grass / path
				break;
			}
	...
	// draw the path
	document.getElementById("demo2").innerHTML ='Length=' +currentPath.length;
	console.log('Current path length: '+currentPath.length-1);
...
function canvasClick(e)
{
	...
	document.getElementById("demo").innerHTML = 'Path = ' +cell[0]+','+cell[1];
	pathStart = pathEnd;
	pathEnd = cell;
